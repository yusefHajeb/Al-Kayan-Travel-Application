...
class SplashProductionScreen extends StatefulWidget {
  const SplashProductionScreen({Key? key}) : super(key: key);

  @override
  State<SplashProductionScreen> createState() => SplateScreenState();
}

class SplateScreenState extends State<SplashProductionScreen>
